...
class ICMHMMcontinuousMO(ICMHMM):
    def __init__(self, *args, **kwargs):
        self.segment_shifts = None
        super(ICMHMMcontinuousMO, self).__init__(*args, **kwargs)
    ...
    def set_observations(self, observations):
        ...
        super(ICMHMMcontinuousMO, self).set_observations(obs)
    ...
    def predict(self, t_step, hidden_state, observations):
        ...
        mean_pred, cov_pred = super(ICMHMMcontinuousMO, self).predict(
